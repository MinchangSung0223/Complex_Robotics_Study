function drawAxis(T,linelength ,lineWidth,T0,opacity,txt,ax,actuated_flag)
    p0 = T0*T*[0,0,0,1]';
    ...
    if actuated_flag==1
        scatter3(ax,p0(1),p0(2),p0(3),'o',MarkerFaceColor=[1,0,0],MarkerFaceAlpha=0.5,SizeData=100);
    elseif actuated_flag==2
        scatter3(ax,p0(1),p0(2),p0(3),'o',MarkerFaceColor=[0,0,1],MarkerFaceAlpha=0.5,SizeData=100);
    end
